<template lang="pug">
  div
    ...
    p.display-1 OPEN GAME LICENSE Version 1.0a
    p.
      The following text is the property of Wizards of the Coast, Inc. and is Copyright 2000 Wizards of the Coast, Inc
      ("Wizards"). All Rights Reserved.
    ol
      li.
        #[strong Definitions]: (a)"Contributors" means the copyright and/or trademark owners who have contributed Open
        ...
        adapted; (c) "Distribute" means to reproduce, license, rent, lease, sell, broadcast, publicly display, transmit
        or otherwise distribute; (d)"Open Game Content" means the game mechanic and includes the methods, procedures,
        ...
        graphic designs; and any other trademark or registered trademark clearly identified as Product identity by the
        owner of the Product Identity, and which specifically excludes the Open Game Content; (f) "Trademark" means
        the logos, names, mark, sign, motto, designs that are used by a Contributor to identify itself or its products
        or the associated products contributed to the Open Game License by the Contributor (g) "Use", "Used" or "Using"
      ...
      li.
        #[strong The License]: This License applies to any Open Game Content that contains a notice indicating that the
        Open Game Content may only be Used under and in terms of this License. You must affix such a notice to any Open
      ...
      li.
        #[strong Offer and Acceptance]: By Using the Open Game Content You indicate Your acceptance of the terms of this License.
      li.
        #[strong Grant and Consideration]: In consideration for agreeing to use this License, the Contributors grant
        You a perpetual, worldwide, royalty-free, non-exclusive license with the exact terms of this License to Use,
        the Open Game Content.
      li.
        #[strong Representation of Authority to Contribute]: If You are contributing original material as Open Game
        Content, You represent that Your Contributions are Your original creation and/or You have sufficient rights to
        grant the rights conveyed by this License.
      li.
        #[strong Notice of License Copyright]: You must update the COPYRIGHT NOTICE portion of this License to include
        the exact text of the COPYRIGHT NOTICE of any Open Game Content You are copying, modifying or distributing, and
        You must add the title, the copyright date, and the copyright holder's name to the COPYRIGHT NOTICE of any
        original Open Game Content you Distribute.
      li.
        #[strong Use of Product Identity]: You agree not to Use any Product Identity, including as an indication as to
        ...
        independent Agreement with the owner of such Trademark or Registered Trademark. The use of any Product Identity
        in Open Game Content does not constitute a challenge to the ownership of that Product Identity. The owner of any
        Product Identity used in Open Game Content shall retain all rights, title and interest in and to that Product Identity.
      li.
        #[strong Identification]: If you distribute Open Game Content You must clearly indicate which portions of the
        work that you are distributing are Open Game Content.
      li.
        #[strong Updating the License]: Wizards or its designated Agents may publish updated versions of this License.
        You may use any authorized version of this License to copy, modify and distribute any Open Game Content
        originally distributed under any version of this License.
      li.
        #[strong Copy of this License]: You MUST include a copy of this License with every copy of the Open Game Content
        You Distribute.
      li.
        #[strong Use of Contributor Credits]: You may not market or advertise the Open Game Content using the name of
        any Contributor unless You have written permission from the Contributor to do so.
      li.
        #[strong Inability to Comply]: If it is impossible for You to comply with any of the terms of this License with
      ...
      li.
        #[strong Termination]: This License will terminate automatically if You fail to comply with all terms herein
        and fail to cure such breach within 30 days of becoming aware of the breach. All sublicenses shall survive the
        termination of this License.
      li.
        #[strong Reformation]: If any provision of this License is held to be unenforceable, such provision shall be
    ...
    p.
      Mass Effect 5e Homebrew. Copyright 2018, Mass Effect 5e; Author Luke Aeschleman, based on original material by
      Wizards of the Coast, Inc. and Electronic Arts Inc. and BioWare.
</template>
